...
# Default value
set iframe_url "http://www.project-open.net/en/install_${platform}_${core_version_id}"
...
switch [string tolower $platform] {
	...
	if {$vmware_p} {
	    set plaform "vm"
	    set iframe_url "http://www.project-open.net/en/install_vm_${core_version_id}"
	} else {
	    set iframe_url "http://www.project-open.net/en/install_${linux_distro}_${core_version_id}"
	}
    }
    default {
	set iframe_url "http://www.project-open.net/en/install_${platform}_${core_version_id}"
